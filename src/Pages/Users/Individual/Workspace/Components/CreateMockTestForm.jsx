...
import { Plus, Trash2, Loader2, ClipboardList, ArrowLeft, RefreshCw, Save, Rocket } from "lucide-react";
  ...
  return (
    <div className="flex flex-col h-full">
          ...
          <div className="space-y-4">
            ...
            <div className={`rounded-lg border p-3 space-y-3 ${isDarkMode ? "border-purple-800/50 bg-purple-950/20" : "border-purple-200 bg-purple-50/30"}`}>
              ...
              <div>
                ...
                <select className={selectCls} value={selectedRoadmapId} onChange={(e) => setSelectedRoadmapId(e.target.value)} disabled={roadmapLoading}>
      ...
      <div className={`px-4 py-3 border-t flex justify-end gap-2 shrink-0 transition-colors duration-300 ${isDarkMode ? "border-slate-800" : "border-gray-200"}`}>
        ...
        <Button onClick={() => handleSubmit("ACTIVE")} disabled={submitting} className="bg-purple-600 hover:bg-purple-700 text-white">
