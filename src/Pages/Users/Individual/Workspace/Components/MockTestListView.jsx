...
import { Search, X, ClipboardList, FolderOpen, Clock, RefreshCw, Plus, Trash2, Loader2 } from "lucide-react";
    ...
    <div className={`h-full flex flex-col ${fontClass}`}>
      ...
      <div className={`px-4 py-3 border-b flex items-center justify-between ${isDarkMode ? "border-slate-800" : "border-gray-200"}`}>
        ...
        <div className="flex items-center gap-2">
          ...
          {onCreateMockTest && (
            <Button onClick={onCreateMockTest} className="bg-purple-600 hover:bg-purple-700 text-white rounded-full h-9 px-4 flex items-center gap-2 transition-all active:scale-95">
