...
function Step1Config({ config, onConfigChange, onNext, isDarkMode = false }) {
  ...
  const validate = () => {
    ...
    if (!String(config.title || "").trim()) {
      errs.title = t("workspace.quiz.manualWizard.step1.errors.titleRequired", "Tên quiz không được để trống.");
    }
    ...
    <div className="space-y-4 py-5">
      ...
      <div>
        ...
        <input
          type="text"
          maxLength={100}
          placeholder={t("workspace.quiz.manualWizard.step1.fields.titlePlaceholder", "Nhập tên quiz...")}
          aria-label={t("workspace.quiz.manualWizard.step1.fields.titleLabel", "Tên quiz")}
          value={config.title || ""}
          onChange={(e) => set("title", e.target.value)}
          className={INPUT_CLS(isDarkMode, !!errors.title)}
        />
      ...
      <div>
        ...
        <textarea
          rows={2}
          placeholder={t("workspace.quiz.manualWizard.step1.fields.descriptionPlaceholder", "Mô tả ngắn về quiz...")}
          aria-label={t("workspace.quiz.manualWizard.step1.fields.descriptionLabel", "Mô tả")}
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <input
            ...
            className={INPUT_CLS(isDarkMode, !!errors.questionCount)}
        ...
        <div>
          ...
          <input
            ...
            className={INPUT_CLS(isDarkMode, !!errors.duration)}
      ...
      <Button
        onClick={handleNext}
        aria-label={t("workspace.quiz.manualWizard.step1.nextButton", "Tạo bộ câu hỏi")}
        className="w-full rounded-xl bg-blue-600 hover:bg-blue-700 text-white py-3 gap-2 text-sm font-semibold"
      >
