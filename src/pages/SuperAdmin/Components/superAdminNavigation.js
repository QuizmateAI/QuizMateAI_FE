...
export const SUPER_ADMIN_MENU_SECTIONS = [
  ...
  {
    id: 'plan-operations',
    labelKey: 'sidebarSections.planOperations',
    defaultLabel: 'Plan operations',
    items: [
      {
        id: 'plans',
      ...
      {
        id: 'ai-plan-overrides',
        labelKey: 'sidebar.aiPlanOverrides',
        defaultLabel: 'Plan Model Overrides',
        icon: Layers,
        to: '/super-admin/ai-plan-overrides',
        matchPrefix: true,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        labelKey: 'sidebar.permissionRequests',
        defaultLabel: 'Permission Requests',
        icon: Hourglass,
        to: '/super-admin/permission-requests',
        matchPrefix: true,
      },
    ],
  },
