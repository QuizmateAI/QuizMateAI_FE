...
const TEMPLATE_I18N_PREFIX = 'individualWorkspaceProfileConfigDialog.mockProfileWizardData.template';
...
export function generateTemplateSuggestion(values) {
  ...
  const sectionSet = {
    FULL_EXAM: [
      i18n.t(`${TEMPLATE_I18N_PREFIX}.sections.fullExam.warmUp`, 'Warm-up matching the exam format'),
      i18n.t(`${TEMPLATE_I18N_PREFIX}.sections.fullExam.core`, 'Core section simulating the real exam'),
      i18n.t(`${TEMPLATE_I18N_PREFIX}.sections.fullExam.sprint`, 'Sprint section at the end'),
    ],
    SECTION_BASED: [
      i18n.t(`${TEMPLATE_I18N_PREFIX}.sections.sectionBased.skillOne`, 'Skill section 1'),
      i18n.t(`${TEMPLATE_I18N_PREFIX}.sections.sectionBased.skillTwo`, 'Skill section 2'),
      i18n.t(`${TEMPLATE_I18N_PREFIX}.sections.sectionBased.errorReview`, 'Section reviewing common mistakes'),
    ],
    PRACTICE_SET: [
      i18n.t(`${TEMPLATE_I18N_PREFIX}.sections.practiceSet.targeted`, 'Targeted practice set'),
      i18n.t(`${TEMPLATE_I18N_PREFIX}.sections.practiceSet.hard`, 'Hard question set'),
      i18n.t(`${TEMPLATE_I18N_PREFIX}.sections.practiceSet.quickReview`, 'Quick self-assessment at session end'),
    ],
  }[format];

  return {
    title: i18n
      .t(`${TEMPLATE_I18N_PREFIX}.title`, '{{examName}} - suggested template', { examName })
      .normalize('NFC'),
    summary: i18n
      .t(
        `${TEMPLATE_I18N_PREFIX}.summary`,
    ...
    sections: sectionSet.map((item, index) => {
      ...
      const defaultKnowledge = i18n.t(
        `${TEMPLATE_I18N_PREFIX}.defaultKnowledge`,
        'your knowledge'
      );
      ...
      for (let i = 0; i < displayCount; i++) {
        ...
        let content = i18n
          .t(
            `${TEMPLATE_I18N_PREFIX}.mockQuestionContent`,
            '[Question {{index}} content auto-generated by AI based on {{topic}}]',
            { index: qIndex, topic: values.knowledgeInput || defaultKnowledge }
          )
          .normalize('NFC');
        let options = [
          i18n.t(`${TEMPLATE_I18N_PREFIX}.defaultOptions.A`, 'A. Option 1'),
          i18n.t(`${TEMPLATE_I18N_PREFIX}.defaultOptions.B`, 'B. Option 2'),
          i18n.t(`${TEMPLATE_I18N_PREFIX}.defaultOptions.C`, 'C. Option 3'),
          i18n.t(`${TEMPLATE_I18N_PREFIX}.defaultOptions.D`, 'D. Option 4'),
      ...
      return {
        ...
        detail: i18n
          .t(
            `${TEMPLATE_I18N_PREFIX}.sectionDetail`,
    ...
    notes: [
      (
        ...
        i18n.t(
          `${TEMPLATE_I18N_PREFIX}.defaultNotePrompt`,
      ...
      (
        ...
        i18n.t(
          `${TEMPLATE_I18N_PREFIX}.defaultNoteStrategy`,
