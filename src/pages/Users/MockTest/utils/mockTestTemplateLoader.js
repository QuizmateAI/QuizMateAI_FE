 ...
 *
 * @param {object} input
 * @param {number} input.workspaceId — BẮT BUỘC kể từ V2026_05_14 (per-workspace scoping)
 ...
 * @param {number} workspaceId — BẮT BUỘC kể từ V2026_05_14 (per-workspace scoping)
 */
