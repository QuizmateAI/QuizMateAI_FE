...
export default function HourglassLoader({ size = '5em', hue = 210 }) {
  ...
  return (
    <svg
      ...
      style={{ '--hue': hue, width: size, height: 'auto' }}
    >
      <clipPath id={topId}>
        <path
      ...
      <g transform="translate(2,2)">
        <g transform="rotate(-90,26,26)" strokeLinecap="round" strokeDashoffset="153.94" strokeDasharray="153.94 153.94" stroke="var(--hg-orbit)" fill="none">
        ...
        <g transform="translate(13.75,9.25)" className="hourglass-loader__model">
          <path d="M 1.5 2 L 23 2 C 23 2 22.5 8.5 19 12 C 16 15.5 13.5 13.5 13.5 16.75 C 13.5 20 16 18 19 21.5 C 22.5 25 23 31.5 23 31.5 L 1.5 31.5 C 1.5 31.5 2 25 5.5 21.5 C 8.5 18 11 20 11 16.75 C 11 13.5 8.5 15.5 5.5 12 C 2 8.5 1.5 2 1.5 2 Z" fill="var(--hg-body)" />
          <g strokeLinecap="round" stroke="var(--hg-sand)">
            ...
            <line y2="31.5" x2="12" y1="16" x1="12" strokeDasharray="1 107" strokeWidth="1" stroke="var(--hg-sand-dark)" className="hourglass-loader__sand-line-left" />
            <line y2="31.5" x2="12.5" y1="16" x1="12.5" strokeDasharray="12 96" strokeWidth="1" stroke="var(--hg-sand-dark)" className="hourglass-loader__sand-line-right" />
            <g strokeWidth="0" fill="var(--hg-sand)">
              <path d="M 12.25 15 L 15.392 13.486 C 21.737 11.168 22.5 2 22.5 2 L 2 2.013 C 2 2.013 2.753 11.046 9.009 13.438 L 12.25 15 Z" clipPath={`url(#${topId})`} />
              <path d="M 12.25 18.5 L 15.392 20.014 C 21.737 22.332 22.5 31.5 22.5 31.5 L 2 31.487 C 2 31.487 2.753 22.454 9.009 20.062 Z" clipPath={`url(#${bottomId})`} />
            </g>
          </g>
          <g strokeWidth="2" strokeLinecap="round" opacity="0.7" fill="none">
            <path d="M 19.437 3.421 C 19.437 3.421 19.671 6.454 17.914 8.846 C 16.157 11.238 14.5 11.5 14.5 11.5" stroke="var(--hg-glare)" className="hourglass-loader__glare-top" />
            <path transform="rotate(180,12.25,16.75)" d="M 19.437 3.421 C 19.437 3.421 19.671 6.454 17.914 8.846 C 16.157 11.238 14.5 11.5 14.5 11.5" stroke="transparent" className="hourglass-loader__glare-bottom" />
          </g>
          <rect height="2" width="24.5" fill="var(--hg-cap)" />
          <rect height="1" width="19.5" y="0.5" x="2.5" ry="0.5" rx="0.5" fill="var(--hg-cap-inner)" />
          <rect height="2" width="24.5" y="31.5" fill="var(--hg-cap)" />
          <rect height="1" width="19.5" y="32" x="2.5" ry="0.5" rx="0.5" fill="var(--hg-cap-inner)" />
        </g>
      </g>
    </svg>
  );
