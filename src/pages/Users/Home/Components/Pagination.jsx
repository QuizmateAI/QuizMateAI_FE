...
function Pagination({ currentPage, totalPages, totalElements, pageSize, onPageChange, onPageSizeChange, isDarkMode }) {
  ...
  return (
    <div className={`flex items-center justify-between mt-3 px-4 ${fontClass}`}>
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <option value={5}>5 / {t("home.pagination.page")}</option>
          <option value={10}>10 / {t("home.pagination.page")}</option>
          <option value={20}>20 / {t("home.pagination.page")}</option>
          <option value={50}>50 / {t("home.pagination.page")}</option>
        </select>
      </div>
    </div>
  );
