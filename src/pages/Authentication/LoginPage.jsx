...
const RegisterOtpVerificationCard = lazy(() =>
  import('./AuthOtpVerificationCards').then((module) => ({
    default: module.RegisterOtpVerificationCard,
  })),
);
const ForgotPasswordOtpVerificationCard = lazy(() =>
  import('./AuthOtpVerificationCards').then((module) => ({
    default: module.ForgotPasswordOtpVerificationCard,
  })),
);
