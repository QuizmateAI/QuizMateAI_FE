...
const budgets = [
  ...
  { label: 'vi workspace locale payload', prefixes: ['i18n-vi-common-', 'i18n-vi-workspace-'], maxBytes: 166 * 1024 },
  { label: 'en workspace locale payload', prefixes: ['i18n-en-common-', 'i18n-en-workspace-'], maxBytes: 147 * 1024 },
