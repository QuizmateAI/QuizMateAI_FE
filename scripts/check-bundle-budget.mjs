...
const budgets = [
  ...
  { label: 'vi group locale payload', prefixes: ['i18n-vi-common-', 'i18n-vi-home-', 'i18n-vi-workspace-', 'i18n-vi-group-'], maxBytes: 270 * 1024 },
  { label: 'en group locale payload', prefixes: ['i18n-en-common-', 'i18n-en-home-', 'i18n-en-workspace-', 'i18n-en-group-'], maxBytes: 240 * 1024 },
